...
/*!
  ...
  size.
*/
SBMemoryPoolRef SBMemoryPoolCreate(SBUInteger baseSize);
/*!
...
*/
void* SBMemoryPoolAlloc(SBMemoryPoolRef aMemPool, SBUInteger bytes);
/*!
...
*/
void* SBMemoryPoolCalloc(SBMemoryPoolRef aMemPool, SBUInteger bytes);
/*!
...
*/
int SBMemoryPoolRealloc(SBMemoryPoolRef aMemPool, void** chunk, SBUInteger bytes);
/*!
