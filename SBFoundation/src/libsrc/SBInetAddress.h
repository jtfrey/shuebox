...
/*!
  ...
  types!
*/
typedef SBUInteger SBInetAddressFamily;
enum {
...
/*!
  ...
  <ul>
    <li>a byte array containing the binary address</li>
    <li>a byte array with an explicit prefix length</li>
    <li>a sockaddr structure (AF_INET or AF_INET6)</li>
    <li>a string containing an appropriate textual form for the address/CIDR</li>
  </ul>
...
*/
+ (SBInetAddress*) inetAddressWithIPv4Bytes:(const void*)bytes prefixLength:(SBUInteger)prefixLength;
/*!
...
/*!
  ...
  considered significant.
*/
+ (SBInetAddress*) inetAddressWithIPv6Bytes:(const void*)bytes prefixLength:(SBUInteger)prefixLength;
/*!
...
*/
- (SBUInteger) copyAddressBytes:(void*)buffer length:(SBUInteger)length;
/*!
  ...
  Returns the actual number of bytes copied to buffer.
*/
- (SBUInteger) copyMaskedAddressBytes:(void*)buffer length:(SBUInteger)length;
/*!
...
*/
- (BOOL) setSockAddr:(struct sockaddr*)sockAddr byteSize:(SBUInteger)byteSize;
/*!
