...
@class SBDateComponents, SBDate, SBString, SBLocale, SBTimeZone;
...
@interface SBCalendar : SBObject
{
  ...
  SBTimeZone*     _timeZone;
  SBLocale*       _locale;
  SBUInteger      _minDaysInFirstWeek,_firstWeekday;
}
...
*/
- (SBDateComponents*) components:(SBUInteger)mask fromDate:(SBDate*)date;
/*!
...
{
  SBUInteger        _mask;
  SBInteger         _fields[SBMaxCalendarUnit];
}
