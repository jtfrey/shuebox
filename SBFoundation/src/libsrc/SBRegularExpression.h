...
#if SB64BitIntegers
#  error SBRegularExpression is not 64-bit clean.
#endif
...
/*!
  ...
  default behavior.
*/
- (id) initWithString:(SBString*)regexString flags:(SBUInteger)flags;
/*!
...
*/
- (id) initWithUTF8String:(const char*)cString flags:(SBUInteger)flags;
/*!
  @method flags
