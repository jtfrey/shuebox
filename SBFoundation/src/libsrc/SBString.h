...
#if SB64BitIntegers
#  error SBString is not 64-bit clean.
#endif
...
*/
typedef SBUInteger SBStringSearchOptions;
enum {
...
*/
typedef SBUInteger SBStringNativeEncoding;
enum {
...
/*!
  ...
  <ul>
    <li>- (SBUInteger) length</li>
    <li>- (UChar) characterAtIndex:(SBUInteger)index</li>
  </ul>
...
*/
+ (id) stringWithUTF8String:(const char*)cString length:(SBUInteger)length;
/*!
...
*/
+ (id) stringWithCharacters:(UChar*)characters length:(SBUInteger)length;
/*!
  ...
  passed to it.
*/
+ (id) stringWithUncopiedCharacters:(UChar*)characters length:(SBUInteger)length freeWhenDone:(BOOL)freeWhenDone;
/*!
...
/*!
  ...
  Unicode.
*/
+ (id) stringWithBytes:(const void*)bytes count:(SBUInteger)count encoding:(const char*)encoding;
...
*/
- (id) initWithUTF8String:(const char*)cString length:(SBUInteger)length;
/*!
...
*/
- (id) initWithCharacters:(UChar*)characters length:(SBUInteger)length;
/*!
...
/*!
  ...
  byte stream (in data) FROM the given character encoding TO Unicode.
*/
- (id) initWithData:(SBData*)data encoding:(const char*)encoding;
/*!
...
*/
- (id) initWithBytes:(const void*)bytes count:(SBUInteger)count encoding:(const char*)encoding;
...
*/
- (BOOL) copyCharactersToBuffer:(UChar*)buffer length:(SBUInteger)length;
/*!
  ...
  buffer is long enough, a trailing NUL character will be included.
*/
- (BOOL) copyUTF8CharactersToBuffer:(unsigned char*)buffer length:(SBUInteger)length;
/*!
...
*/
- (BOOL) copyUTF32CharactersToBuffer:(UChar32*)buffer length:(SBUInteger)length;
/*!
...
- (int) intValue;
/*!
  @method longLongIntValue
  
  Attempts to parse the receiver as a long long integer value.  Returns 0 if unable to parse.
*/
...
/*!
  ...
  <ul>
    <li>- (SBUInteger) length</li>
    <li>- (UChar) characterAtIndex:(SBUInteger)index</li>
    <li>- (void) replaceCharactersInRange:(SBRange)range withCharacters:(UChar*)characters length:(SBUInteger)length</li>
  </ul>
...
/*!
  ...
  fixed capacity.
*/
- (void) replaceCharactersInRange:(SBRange)range withCharacters:(UChar*)characters length:(SBUInteger)length;
...
*/
- (void) appendCharacters:(const UChar*)characters length:(SBUInteger)length;
/*!
  @method appendFormat:...
...
*/
- (void) insertString:(SBString*)aString atIndex:(SBUInteger)index;
/*!
  ...
  within the receiver.
*/
- (void) insertCharacters:(const UChar*)characters length:(SBUInteger)length atIndex:(SBUInteger)index;
/*!
...
/*!
  ...
  of cString.
*/
- (void) setWithUTF8String:(const char*)cString length:(SBUInteger)length;
