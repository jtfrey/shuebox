...
/*!
  ...
  @discussion
    Adds the receiver to the specified runloop, such that when that runloop
    is given CPU time in aMode, the receiver will be checked for available
    space or data; if available, then the receiver's delegate will be sent
    the stream:handleEvent: message with an event of SBStreamEventSpaceAvailable
    or SBStreamEventBytesAvailable, respectively.
*/
...
/*!
  ...
  @discussion
    Removes the receiver from the list of input/output sources for the given
    runloop and mode.
*/
...
/*!
  ...
  @discussion
    ...
    In addition, the
      ...
      - (BOOL) getBuffer:(void**)buffer length:(size_t*)length;
...
/*!
  ...
  @discussion
    ...
    In addition, the
      ...
      - (size_t) write:(void*)buffer length:(size_t)length;
...
*/
+ (id) outputStreamToBuffer:(void*)buffer capacity:(size_t)capacity;
...
*/
- (id) initToBuffer:(void*)buffer capacity:(size_t)capacity;
...
+ (void) getStreamsToHost:(SBHost*)host port:(int)port inputStream:(SBInputStream**)inputStream outputStream:(SBOutputStream**)outputStream;
...
/*!
  ...
  The SSL interfaces have not yet been added to this class cluster.
*/
