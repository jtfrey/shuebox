...
*/
+ (id) dataWithBytes:(const void*)bytes length:(size_t)length;
...
*/
+ (id) dataWithBytesNoCopy:(const void*)bytes length:(size_t)length;
...
*/
+ (id) dataWithBytesNoCopy:(const void*)bytes length:(size_t)length freeWhenDone:(BOOL)freeWhenDone;
...
*/
- (void) replaceBytesInRange:(SBRange)range withBytes:(const void*)bytes length:(size_t)length;
