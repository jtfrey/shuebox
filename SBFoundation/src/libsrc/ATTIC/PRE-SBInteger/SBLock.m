...
//
  ...
  - (id) initWithConditionValue:(int)conditionValue
  {
    if ( (self = [super init]) ) {
...
//
  ...
  - (int) conditionValue { return _conditionValue; }
  
//

  - (void) lockOnConditionValue:(int)conditionValue
  {
...
//
  ...
  - (BOOL) tryLockOnConditionValue:(int)conditionValue
  {
    SBThread*             currentThread = [SBThread currentThread];
...
//
  ...
  - (void) unlockWithConditionValue:(int)conditionValue
  {
    pthread_mutex_t*      mutex = [self nativeMutex];
    SBThread*             currentThread = [SBThread currentThread];
