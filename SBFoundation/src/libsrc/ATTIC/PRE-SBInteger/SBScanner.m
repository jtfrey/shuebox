...
- (BOOL) scanBase10Integer:(unsigned long long*)magnitude sign:(int*)sign overflow:(BOOL*)overflow;
- (BOOL) scanBase16Integer:(unsigned long long*)magnitude overflow:(BOOL*)overflow;
...
//
  ...
  - (BOOL) scanBase10Integer:(unsigned long long*)magnitude
    sign:(int*)sign
...
//
  ...
  - (BOOL) scanBase16Integer:(unsigned long long*)value
     overflow:(BOOL*)overflow
  {
    unsigned long long      digits = 0ULL;
    UChar                   digit;
...
//
  ...
  - (BOOL) scanInt:(int*)value
  {
    ...
    if ( _scanRange.length && [self scanBase10Integer:&magnitude sign:&sign overflow:&overflow] ) {
      if ( sign == -1 ) {
        if ( overflow || (magnitude > -((unsigned long long)INT_MIN)) )
          magnitude = INT_MIN;
      } else {
        if ( overflow || (magnitude > ((unsigned long long)INT_MAX)) )
          magnitude = INT_MAX;
      }
      if ( value )
...
//
  ...
  - (BOOL) scanLongLong:(long long*)value
  {
    ...
    if ( _scanRange.length && [self scanBase10Integer:&magnitude sign:&sign overflow:&overflow] ) {
      if ( sign == -1 ) {
        if ( overflow || (magnitude > -((unsigned long long)LONG_LONG_MIN)) )
          magnitude = LONG_LONG_MIN;
      } else {
        if ( overflow || (magnitude > ((unsigned long long)LONG_LONG_MAX)) )
...
//
  ...
  - (BOOL) scanHexInt:(unsigned*)value
  {
    ...
    if ( _scanRange.length && [self scanBase16Integer:&magnitude overflow:&overflow] ) {
      if ( value )
        *value = ( ( overflow || (magnitude > ((unsigned long long)UINT_MAX)) ) ? UINT_MAX : (unsigned)magnitude );
      return YES;
    }
    return NO;
  }
...
//
  ...
  - (BOOL) scanHexLongLong:(unsigned long long*)value
  {
    ...
    if ( _scanRange.length && [self scanBase16Integer:&magnitude overflow:&overflow] ) {
      if ( value )
        *value = ( ( overflow || (magnitude > ((unsigned long long)ULONG_LONG_MAX)) ) ? ULONG_LONG_MAX : (unsigned long long)magnitude );
      return YES;
    }
    return NO;
  }
