...
//
  ...
  + (SBCharacterSet*) whitespaceCharacterSet
  {
    ...
    static UChar             __SBWhitespaceCharacterSetPattern[] = { '[' , ':' , 'Z' , 's' , ':' , ']' , 0 };
...
//
  ...
  + (SBCharacterSet*) whitespaceAndNewlineCharacterSet
  {
    ...
    static UChar             __SBWhitespaceAndNewlineCharacterSetPattern[] = { '[' , ':' , 'Z' , ':' , ']' , 0 };
...
//
  ...
  + (SBCharacterSet*) newlineCharacterSet
  {
    ...
    static UChar             __SBNewlineCharacterSetPattern[] = { '[' , ':' , 'Z' , 'l' , ':' , ']' , 0 };
  ...
  - (SBData*) bitmapRepresentation
  {
    ...
    if ( _icuCharSet ) {
      ...
      if ( icuErr == U_BUFFER_OVERFLOW_ERROR ) {
        uint16_t*   buffer = (uint16_t*)malloc(actLen * sizeof(uint16_t));
        if ( buffer ) {
          icuErr = U_ZERO_ERROR;
          uset_serialize(
              _icuCharSet,
