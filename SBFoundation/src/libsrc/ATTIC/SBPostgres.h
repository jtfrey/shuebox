...
@class SBNotification, SBPostgresQuery, SBPostgresQueryResult;
...
*/
@interface SBPostgresDatabase : SBObject
{
  SBString*       _connectionString;
  PGconn*         _databaseConnection;
  SBArray*        _searchSchema;
  SBArray*        _preparedQueries;
  
  SBArray*        _errorMessageStack;
  unsigned int    _checkpointIndex;
...
/*!
  ...
  method can be either an SBString or an SBPostgresQuery object.
  
  Returns an SBPostgresQueryResult object which wraps the PGresult data
  structure.
*/
- (SBPostgresQueryResult*) executeQuery:(id)aQuery;
/*!
  @method executeQueryWithBooleanResult:
...
/*!
  ...
  performed in the connected database, where XXXXXXX is some arbitrary string.  The objects are
  registered with one or more strings (XXXXXXX above) to which they respond.  The objects must
  implement the notificationFromDatabase: method.
...
*/
- (size_t) escapeForPostgresDatabase:(SBPostgresDatabase*)aDatabase inBuffer:(char*)buffer byteSize:(size_t)byteSize;
...
*/
- (id) initWithQueryString:(SBString*)queryString parameterCount:(int)parameterCount;
/*!
  @method queryString
...
/*!
  ...
  Returns NO if the value could not be bound to the specified parameter.
*/
- (BOOL) bindInt2Value:(int16_t)value toParameter:(int)parameter;
/*!
  ...
  Returns NO if the value could not be bound to the specified parameter.
*/
- (BOOL) bindInt4Value:(int32_t)value toParameter:(int)parameter;
/*!
  ...
  Returns NO if the value could not be bound to the specified parameter.
*/
- (BOOL) bindInt8Value:(int64_t)value toParameter:(int)parameter;
/*!
  ...
  Returns NO if the value could not be bound to the specified parameter.
*/
- (BOOL) bindFloatValue:(float)value toParameter:(int)parameter;
/*!
  ...
  Returns NO if the value could not be bound to the specified parameter.
*/
- (BOOL) bindDoubleValue:(double)value toParameter:(int)parameter;
/*!
  ...
  Returns NO if the value could not be bound to the specified parameter.
*/
- (BOOL) bindUTF8String:(const char*)string byteSize:(size_t)byteSize toParameter:(int)parameter;
/*!
  ...
  Returns NO if the value could not be bound to the specified parameter.
*/
- (BOOL) bindUTF8StringNoCopy:(const char*)string byteSize:(size_t)byteSize toParameter:(int)parameter;
/*!
  ...
  Returns NO if the value could not be bound to the specified parameter.
*/
- (BOOL) bindObject:(id)object toParameter:(int)parameter;
/*!
...
/*!
  ...
  will produce an instance of SBDate.  For any "exotic" SQL type for which no corresponding
  class is known, the objectForRow:fieldNum: method will return an SBData object containing
  the binary data returned by the database.
*/
@interface SBPostgresQueryResult : SBObject
{
...
- (BOOL) postgresType:(Oid*)typeOid forFieldNum:(int)fieldNum;
- (BOOL) postgresTypeModifier:(int*)typeMod forFieldNum:(int)fieldNum;
- (BOOL) postgresStorageSize:(size_t*)storageSize forFieldNum:(int)fieldNum;

- (BOOL) isNullValueAtRow:(int)row fieldNum:(int)fieldNum;
- (BOOL) sizeOfValue:(size_t*)byteSize atRow:(int)row fieldNum:(int)fieldNum;
- (BOOL) getValuePointer:(void**)valuePtr atRow:(int)row fieldNum:(int)fieldNum;
- (size_t) copyValueAtRow:(int)row fieldNum:(int)fieldNum toBuffer:(void*)buffer length:(size_t)length;

- (BOOL) getOidOfInsertedRow:(Oid*)anOid;

- (Class) classForFieldNum:(int)fieldNum;
- (id) objectForRow:(int)row fieldNum:(int)fieldNum;

@end

/*!
  @category SBDate(SBPostgresDateAdditions)
  @discussion
...
*/
@interface SBDate(SBPostgresDateAdditions)
