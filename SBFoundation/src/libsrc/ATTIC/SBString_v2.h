...
@class SBData, SBLocale, SBCharacterSet, SBRegularExpression;
...
@interface SBString : SBObject
{
  ...
  struct {
    ...
    unsigned int    doNotFreeWhenDone   : 1;
  } _flags;
}
...
*/
+ (SBString*) stringWithUTF8String:(const char*)cString length:(size_t)length;
...
/*!
  ...
  passed to it.
*/
+ (SBString*) stringWithUncopiedCharacters:(UChar*)characters length:(int)length freeWhenDone:(BOOL)freeWhenDone;
...
*/
- (id) initWithUTF8String:(const char*)cString length:(size_t)length;
...
/*!
  @method initWithUncopiedCharacters:length:freeWhenDone:
  
  Initialize the receiver to wrap the string of UTF-16 characters passed to it.
*/
...
+ (SBMutableString*) mutableStringWithUTF8String:(const char*)cString length:(size_t)length;
+ (SBMutableString*) mutableStringWithCharacters:(UChar*)characters length:(int)length;
+ (SBMutableString*) mutableStringWithString:(SBString*)aString;
+ (SBMutableString*) mutableStringWithFormat:(const char*)format,...;
+ (SBMutableString*) mutableStringWithBytes:(const void*)bytes count:(int)count encoding:(const char*)encoding;
