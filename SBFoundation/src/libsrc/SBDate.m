...
- (id) initWithDays:(SBInteger)days seconds:(double)seconds;
...
- (id) initWithMonths:(SBInteger)months days:(SBInteger)days seconds:(double)seconds;
...
//
  ...
  + (id) timeIntervalWithDays:(SBInteger)days
    seconds:(double)seconds
  {
    SBInteger   altDays = 0, months = 0;
...
//
  ...
  + (id) timeIntervalWithMonths:(SBInteger)months
    days:(SBInteger)days
    seconds:(double)seconds
  {
    SBInteger   altDays = 0, altMonths = 0;
...
//
  ...
  - (void) summarizeToStream:(FILE*)stream
  {
    ...
    fprintf(
        ...
        " {\n"
        "  seconds:          %lf\n"
        "  days:             " SBIntegerFormat "\n"
        "  months:           " SBIntegerFormat "\n"
        "}\n",
...
@implementation SBTimeInterval_Days
  ...
  - (id) initWithDays:(SBInteger)days
    seconds:(double)seconds
  {
...
@implementation SBTimeInterval_Months
  ...
  - (id) initWithMonths:(SBInteger)months
    days:(SBInteger)days
    seconds:(double)seconds
  {
...
//
  ...
  + (SBDate*) dateWithSeconds:(SBInteger)seconds
...
//
  ...
  - (id) initWithSeconds:(SBInteger)seconds
    sinceDate:(SBDate*)anotherDate
  {
