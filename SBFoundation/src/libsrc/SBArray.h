...
/*!
  ...
  <ul>
    ...
    <li>- (id) objectAtIndex:(SBUInteger) index</li>
  </ul>
...
*/
+ (id) arrayWithObjects:(id*)initialObjects count:(SBUInteger)count;
/*!
...
*/
- (id) initWithObjects:(id*)initialObjects count:(SBUInteger)count;
/*!
...
*/
- (SBUInteger) indexOfObject:(id)anObject inRange:(SBRange)range;
/*!
...
*/
- (SBUInteger) indexOfObjectIdenticalTo:(id)anObject inRange:(SBRange)range;
/*!
...
/*!
  ...
  <ul>
    <li>- (void) insertObject:(id)object atIndex:(SBUInteger)index;</li>
    <li>- (void) removeObjectAtIndex:(SBUInteger)index;</li>
    <li>- (void) addObject:(id)object;</li>
    <li>- (void) removeLastObject;</li>
    <li>- (void) replaceObject:(id)object atIndex:(SBUInteger)index;</li>
  </ul>
...
*/
- (void) insertObject:(id)object atIndex:(SBUInteger)index;
/*!
...
*/
- (void) replaceObject:(id)object atIndex:(SBUInteger)index;
...
*/
- (void) exchangeObjectAtIndex:(SBUInteger)index1 withObjectAtIndex:(SBUInteger)index2;
/*!
...
*/
- (void) removeObjectsFromIndices:(SBUInteger*)indices numIndices:(SBUInteger)count;
/*!
