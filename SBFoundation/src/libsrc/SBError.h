...
*/
+ (id) posixErrorWithCode:(SBInteger)code supportingData:(SBDictionary*)data;
/*!
  ...
  the provided code and supporting data.
*/
+ (id) foundationErrorWithCode:(SBInteger)code supportingData:(SBDictionary*)data;
/*!
...
*/
+ (id) errorWithDomain:(SBString*)domain code:(SBInteger)code supportingData:(SBDictionary*)data;

/*!
  @method errorWithDomain:code:supportingObjectsAndKeys:...
  @discussion
  Returns an autoreleased instance which wraps an error in the specified domain with the
  provided code and supporting data per a list of objects and keys that will be automatically
  turned into a SBDictionary.
*/
+ (id) errorWithDomain:(SBString*)domain code:(SBInteger)code supportingObjectsAndKeys:(id)firstObject,...;
...
*/
- (id) initWithDomain:(SBString*)domain code:(SBInteger)code supportingData:(SBDictionary*)data;
...
*/
extern SBString const* SBErrorExplanationKey;

/*!
  @const SBErrorUnderlyingErrorKey
  @discussion
  Recommended standard way to embed additional SBErrors in an SBError "wrapper".  The
  value for this key should be an SBError or an SBArray of SBErrors.
*/
extern SBString const* SBErrorUnderlyingErrorKey;
