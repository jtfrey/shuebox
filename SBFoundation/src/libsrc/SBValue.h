...
/*!
  ...
  @discussion
    Returns a newly-initialized, autoreleased instance that wraps the given
    SBInteger value.
*/
...
/*!
  @method numberWithUnsignedInt64:
...
/*!
  @method integerValue
  @discussion
    Returns the value of the receiver as an SBInteger.  Values outisde the
    range of an SBInteger are truncated to the min/max value.
*/
- (SBInteger) integerValue;
/*!
  @method unsignedIntegerValue
  @discussion
    Returns the value of the receiver as an SBUInteger.  Values outisde the
    range of an SBUInteger are truncated to the min/max value.
*/
...
/*!
  @method unsignedInt64Value
  
  Returns the value of the receiver as an unsigned 64-bit integer.  Values outside
  the range of a uint64_t are truncated to the min/max value.
*/
...
/*!
  @method compare:
  @discussion
    Compare the value of the receiver to the value of otherNumber.  The nature of
    the comparison is dictated by the underlying atomic type of the receiver.  In
    other words, if the receiver wrapped a BOOL, the value of the receiver is compared
    to the boolValue of otherNumber.
*/
- (SBComparisonResult) compare:(SBNumber*)otherNumber;
/*!
  @method isEqualToNumber:
  @discussion
    Returns YES if [self compare:number] is SBOrderedSame -- so equality is based on the
    same conditions outlined for the compare: method.
*/
- (BOOL) isEqualToNumber:(SBNumber*)number;
/*!
  @method writeToStream:
  @discussion
    Write a textual form of the receiver's value to the given C stdio stream.
*/
