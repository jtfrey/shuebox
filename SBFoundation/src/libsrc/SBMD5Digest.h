...
#ifdef SOLARIS
#  if SB64BitIntegers
#    error Solaris MD5 is not 64-bit safe!!!
#  else
#    include <md5.h>
#  endif
#endif
...
*/
- (BOOL) appendBytesToDigest:(const void*)bytes length:(SBUInteger)length;
...
/*!
  @method md5DigestForUTF8MatchesString:
  @discussion
    Returns YES if the MD5 digest of the receiver string (in UTF8 encoding)
    is equal to the 32-character digestAsString.
*/
- (BOOL) md5DigestForUTF8MatchesString:(SBString*)digestAsString;

/*!
  @method md5DigestMatchesString:
  @discussion
    Returns YES if the MD5 digest of the receiver string is equal to the
    32-character digestAsString.
*/
